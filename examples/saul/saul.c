...
/* States */
enum TRU2AIR_CLIENT_NODE_I2C_HANDLER_STATE {NODE_I2C_SLAVE_INIT, NODE_I2C_MASTER_INIT, REQUIRE_SENSACT_NAME, REQUIRE_SENSOR_RETURN_TYPE, DEBUG };
volatile enum TRU2AIR_CLIENT_NODE_I2C_HANDLER_STATE STATE = NODE_I2C_SLAVE_INIT;
enum TRU2AIR_I2C_HEADER_ACTION comm_type = GET_SENSACT_NUM;
